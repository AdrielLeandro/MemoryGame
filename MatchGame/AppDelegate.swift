...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        let initialGameViewController = InitialGameViewController()
        initialGameViewController.viewModel = InitialGameViewModel()

        window?.rootViewController = configureNavigationWith(controller: initialGameViewController)
